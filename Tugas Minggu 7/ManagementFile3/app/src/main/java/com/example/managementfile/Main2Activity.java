...
public class Main2Activity extends AppCompatActivity {
    //mendeklarasikan variable show text
    TextView showText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showText = (TextView) findViewById(R.id.getText);//melakukan pemanngilan id
    }
    ...
    public void getPrivate(View view) {
        File folder = getExternalFilesDir("Lukidp"); //folder name
        File myFile = new File(folder, "myData2.txt"); //filename
        String text = getdata(myFile);
        if (text != null) {
            showText.setText(text);//berfungsi memunculkan data yang telah di input
        } else {
            showText.setText("No Data");
        }
    }
